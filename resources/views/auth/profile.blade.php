    ...
    <div class="card-header d-sm-flex align-items-center justify-content-between py-3">
     ...
     <div class="card-body">
        ...
        @method('patch')
            ...
            <div class="form-group row">
                <label for="dokter" class="col-md-2 col-form-label text-md-right">Dokter Jaga</label>
                <div class="col-md-6">
                    <input id="dokter" type="text" class="form-control @error('dokter') is-invalid @enderror" name="dokter" value="{{ old('dokter',$user->dokter) }}" required autocomplete="dokter" >
                        @error('dokter')
                        <span class="invalid-feedback" role="alert"
                        <strong>{{ $message }}</strong>
                        </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="profesi" type="text" class="form-control @error('profesi') is-invalid @enderror" name="profesi" required>
                                    ...
                                    <option value="Admin" {{$user->profesi == "Staff" ? 'selected':''}}>Admin</option>
                                    @error('profesi')
                                    <span class="invalid-feedback" role="alert"
                                    <strong>{{ $message }}</strong>
                                    </span>
