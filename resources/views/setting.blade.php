                    ...
                    {{method_field('PATCH') }}
                        ...
                        <div class="form-group row">
                           <div class="col-md-4 "></div>
                            ...
                            <div class="col-md-8 ">
                                <input type="image" class ="img-fluid" id="image" value="{{$data->gambar}}" alt="Login" src="{{url('/storage/app/public/logo/'.$data->gambar)}}" width="100px">
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                <label for="nama_klinik">Administrasi Klinik</label>
                            </div>
                            <div class="col-sm-8 mb-3 mb-sm-0">
