<head>
  ...
  <link rel="shortcut icon" href="{{URL::asset('public/storage/logo/logo.png')}}">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item {{ set_menu(['rm', 'rm.tambah', 'rm.edit','rm.list','rm.lihat','rm.tambah.id','tagihan']) }}">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#rekammedis" aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-file-medical"></i>
          <span>Rekam Medis</span>
        </a>
        <div id="rekammedis" class="collapse {{ set_show(['rm', 'rm.tambah', 'rm.edit','rm.lihat','rm.tambah.id']) }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
...
@endif
      <li class="nav-item {{ set_menu(['logout']) }}">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item - Dokter Jaga -->
            <li class="nav-item">
              <a class="nav-link" href="#" id="messagesDropdown" style="padding: 2px;">
                <span class="badge badge-{{Auth::user()->profesi ? 'warning ' :'warning'}}">dr. {{Auth::user()->dokter}}</span>
              </a>
            </li>
