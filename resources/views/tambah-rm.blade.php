        ...
        <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form class="user" action="">
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3 mb-sm-0">
                                <label for="identitas">No KTP / Passport</label>
                                <input type="text" class="form-control " name="identitas" value="{{$iden->identitas}}" readonly>
                          </div>
                          <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    @endforeach
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <label for="tanggal-pemeriksaan">Tanggal Pemeriskaan</label>
                                <input type="date" class="form-control " name="periksa" value="{{Request::old('periksa')}}" required>
                            </div>
                          </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control "id="penunjang" name="penunjang" {{Auth::user()->profesi !== "Dokter","Admin" ? 'disabled="true"': ''}}>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control " name="diagnosis" {{Auth::user()->profesi !== "Dokter","Admin" ? 'readonly': ''}}>
                          </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control " name="reseplist" id="reseplist" {{Auth::user()->profesi !== "Dokter","Admin" ? 'disabled="true"': ''}}>
                                <option value="" selected disabled>Pilih satu</option>
